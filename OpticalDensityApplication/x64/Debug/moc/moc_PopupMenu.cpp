...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PopupMenu_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PopupMenu_t qt_meta_stringdata_PopupMenu = {
    {
QT_MOC_LITERAL(0, 9), // "PopupMenu"
QT_MOC_LITERAL(10, 18), // "contextMenuRequest"
QT_MOC_LITERAL(29, 0) // ""

    },
    "PopupMenu\0contextMenuRequest\0"
};
...
void PopupMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PopupMenu *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject PopupMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_PopupMenu.offsetsAndSize,
    qt_meta_data_PopupMenu,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PopupMenu_t
